...
fn salt_padding(init_salt: &mut String)->&String{
    let uni_hash1 = env::var("DB_PWD_SALT1").expect("DB_PWD_SALT1 env variable not set");
    let uni_hash2 = env::var("DB_PWD_SALT2").expect("DB_PWD_SALT2 env variable not set");
